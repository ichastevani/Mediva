...
fun RegisterScreen(
  ...
  LaunchedEffect(key1 = uiStatePMR.transaction) {
    when (uiStatePMR.transaction) {
      ...
      is PMRTransactionUiState.Success -> {
        ...
        // Log.d("RegisterScreen", "transactionData: ${transactionData}")
  ...
  LaunchedEffect(key1 = usStateMetaMask.isTransactionSuccess) {
    if(usStateMetaMask.isTransactionSuccess){
...
fun RegisterUI(
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
    Column(modifier = Modifier.padding(16.dp)) {
      ...
      Spacer(modifier = Modifier.height(16.dp)) // To provide space before the text
      Row(
        modifier = Modifier.fillMaxWidth(),
        ...
        Text(
          text = "Login here",
          style = MaterialTheme.typography.bodyLarge.copy(color = colorScheme.primary),
          modifier = Modifier
